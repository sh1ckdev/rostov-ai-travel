...
// ВНИМАНИЕ: Этот сервис временно отключен, так как он зависит от статических данных
...
export class AIService {
  ...
  private static generateStaticResponse(message: string): { content: string; suggestions?: AIRecommendation[] } {
    ...
    if (lowerMessage.includes('привет') || lowerMessage.includes('здравствуй')) {
      return {
        content: 'Привет! Я ваш AI-помощник по туризму в Таганроге. Могу помочь с рекомендациями по достопримечательностям, маршрутам и отелям. Что вас интересует?',
        suggestions: [
          {
            id: '1',
    ...
    if (lowerMessage.includes('достопримечательности') || lowerMessage.includes('что посмотреть')) {
      return {
        content: 'В Таганроге много интересных мест! Рекомендую посетить:\n\n• Дом-музей А.П. Чехова - родина великого писателя\n• Набережную Таганрогского залива - красивое место для прогулок\n• Таганрогский художественный музей - богатая коллекция искусства\n• Парк им. Горького - центральный парк города\n• Музей градостроительства - история развития города',
        suggestions: [
          {
            id: '1',
            title: 'Дом-музей Чехова',
    ...
    if (lowerMessage.includes('отели') || lowerMessage.includes('где остановиться')) {
      return {
        content: 'В Таганроге есть отели на любой бюджет:\n\n• Отель "Таганрог" (4*) - комфортный отель в центре\n• Гостиница "Бристоль" (3*) - классическая гостиница\n• Бизнес-отель "Петровский" (4*) - для деловых поездок\n• Хостел "Молодежный" (2*) - бюджетный вариант\n• Отель "Чехов" (3*) - семейный отель\n• Апарт-отель "На заливе" (4*) - для длительного проживания',
        suggestions: [
          {
            id: '1',
            title: 'Отель "Таганрог"',
            description: 'Комфортный отель',
            category: 'HOTEL',
            confidence: 0.9,
    ...
    if (lowerMessage.includes('еда') || lowerMessage.includes('ресторан') || lowerMessage.includes('кухня')) {
      return {
        content: 'В Таганроге отличная кухня! Рекомендую:\n\n• Ресторан "Чехов" - традиционные блюда региона\n• Множество кафе в центре города\n• Уличная еда на набережной\n• Местные специалитеты: азовская уха, рыба в сметане, вареники',
        suggestions: [
          {
            id: '1',
            title: 'Ресторан "Чехов"',
    ...
    // Общий ответ
    return {
        content: 'Спасибо за вопрос! Я могу помочь с:\n\n• Рекомендациями по достопримечательностям Таганрога\n• Созданием маршрутов по городу\n• Поиском отелей и размещения\n• Информацией о ресторанах и кафе\n• Общими вопросами о городе\n\nЗадайте более конкретный вопрос, и я дам подробный ответ!',
      suggestions: [
        {
          id: '1',
  ...
  private static getFallbackRecommendations(): AIRecommendation[] {
    return [
      {
        id: '1',
        title: 'Посетите Дом-музей Чехова',
        description: 'Родина великого писателя с богатой историей',
        category: 'CULTURE',
        confidence: 0.9,
      ...
      },
      {
        ...
        description: 'Красивая набережная с видом на залив',
        category: 'NATURE',
        confidence: 0.8,
      ...
      },
      {
        ...
        description: 'Рекомендуем рестораны с местной кухней',
        category: 'RESTAURANT',
        confidence: 0.7,
