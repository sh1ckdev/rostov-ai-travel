...
const SimpleMapView: React.FC<SimpleMapViewProps> = ({
  ...
  const handleLocationPress = (coordinate: { latitude: number; longitude: number }) => {
    if (onLocationSelect) {
      ...
      <View style={styles.mapPlaceholder}>
        ...
        <View style={styles.mapContent}>
          <Text style={styles.mapDescription}>
            Для полной функциональности карт необходимо настроить Google Maps API или использовать development build.
          </Text>
          
          <View style={styles.locationButtons}>
            <TouchableOpacity
              style={styles.locationButton}
              onPress={() => handleLocationPress(initialRegion)}
            >
